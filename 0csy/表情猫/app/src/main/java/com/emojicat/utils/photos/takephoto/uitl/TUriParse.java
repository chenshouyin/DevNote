package com.emojicat.utils.photos.takephoto.uitl;
...
import com.emojicat.utils.photos.takephoto.uitl.*;
...
public class TUriParse {
    ...
    public static Uri getUriForFile(Context context, File file) {
        return FileProvider.getUriForFile(context, com.emojicat.utils.photos.takephoto.uitl.TConstant.getFileProviderName(context), file);
    }
    ...
    public static String parseOwnUri(Context context,Uri uri){
        if(uri==null)return null;
        String path;
        if(TextUtils.equals(uri.getAuthority(), com.emojicat.utils.photos.takephoto.uitl.TConstant.getFileProviderName(context))){
    ...
    public static File getFileWithUri(Uri uri, Activity activity) {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(scheme)){
            ...
            }else if(TextUtils.equals(uri.getAuthority(), com.emojicat.utils.photos.takephoto.uitl.TConstant.getFileProviderName(activity))){
