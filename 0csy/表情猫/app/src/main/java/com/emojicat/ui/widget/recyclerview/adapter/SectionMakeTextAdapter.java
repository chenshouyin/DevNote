 ...
 */
public class SectionMakeTextAdapter extends BaseSectionQuickAdapter<MySection, BaseViewHolder> {
    /**
     ...
     */
    public SectionMakeTextAdapter(int layoutResId, int sectionHeadResId, List data) {
