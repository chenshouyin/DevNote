package com.emojicat.utils.photos.takephoto.compress;

import android.content.Context;
import android.text.TextUtils;

import com.emojicat.utils.photos.takephoto.compress.*;
 ...
 */
public class CompressImageImpl implements com.emojicat.utils.photos.takephoto.compress.CompressImage {
    private CompressImageUtil compressImageUtil;
    private ArrayList<TImage> images;
    private CompressListener listener;

    public static com.emojicat.utils.photos.takephoto.compress.CompressImage of(Context context, com.emojicat.utils.photos.takephoto.compress.CompressConfig config, ArrayList<TImage> images, CompressListener listener) {
    ...
    private CompressImageImpl(Context context, com.emojicat.utils.photos.takephoto.compress.CompressConfig config, ArrayList<TImage> images, CompressListener listener){
