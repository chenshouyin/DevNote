package com.emojicat.ui.widget.banner;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.view_bananer_gray_radius;
    private int mIndicatorUnselectedResId = R.drawable.view_bananer_white_radius;
    private int defaultImage = R.mipmap.view_bananer_default_image;
    private int count;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId =typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.view_bananer_gray_radius);
        mIndicatorUnselectedResId =typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.view_bananer_white_radius);
        defaultImage =typedArray.getResourceId(R.styleable.Banner_default_image, R.mipmap.view_bananer_default_image);
    ...
    private void initView(Context context, AttributeSet attrs) {
        imageViews.clear();
        View view = LayoutInflater.from(context).inflate(R.layout.view_bananer_banner, this, true);
    ...
    public void setBannerTitle(String[] titles) {
        ...
        if (bannerStyle==BannerConfig.CIRCLE_INDICATOR_TITLE||
            ...
            if (titles != null && titles.length > 0) {
                ...
                numIndicator.setBackgroundResource(R.drawable.view_bananer_black_background);
            }
        }
    }
    ...
    private void setData() {
        ...
        viewPager.setOnPageChangeListener(this);//set����add����api�汾
        if (gravity!=-1)
