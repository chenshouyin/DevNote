...
public class CompressImageUtil{
	private com.emojicat.utils.photos.takephoto.compress.CompressConfig config;
	private Context context;
	Handler mhHandler = new Handler();
	public CompressImageUtil(Context context, com.emojicat.utils.photos.takephoto.compress.CompressConfig config) {
		this.context=context;
		this.config=config==null? com.emojicat.utils.photos.takephoto.compress.CompressConfig.ofDefaultConfig():config;
	}
